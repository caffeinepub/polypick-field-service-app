import { c as createLucideIcon, u as useParams, a as useNavigate, b as useInternetIdentity, d as useClient, e as useInteractions, f as useUpdateClient, g as useCreateInteraction, r as reactExports, t as todayInputStr, j as jsxRuntimeExports, S as Skeleton, B as Button, U as Users, h as Badge, C as Card, i as CardHeader, k as CardTitle, l as CardContent, P as Phone, M as MapPin, F as FileText, m as formatDate, n as Plus, o as User, p as StatusBadge, L as Label, I as Input, q as LoaderCircle, s as Select, v as SelectTrigger, w as SelectValue, x as SelectContent, y as SelectItem, z as ue, A as dateInputToNs } from "./index-DbjPUQDs.js";
...
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogFooter, e as DialogTrigger } from "./dialog-x_F93RN-.js";
...
import { d as decodeContacts, s as stripIndustryTag, a as stripContactsTag, S as Smartphone, g as genContactId, e as encodeContacts } from "./ClientsPage-BQp6f36v.js";
import { A as ArrowLeft } from "./arrow-left-BifkhYrz.js";
import { B as Building2 } from "./building-2-C6wH6nNa.js";
import { P as Pencil } from "./pencil-DZyY2q8y.js";
import { P as Printer } from "./printer-BujzTYqY.js";
import { E as ExternalLink } from "./external-link-B3ZAR0QS.js";
import { M as Mail } from "./mail-RM2vOHhT.js";
import { T as Trash2 } from "./trash-2-AM3OX5RE.js";
import "./index-CzBemFCv.js";
import "./checkbox-RI9XoOjI.js";
import "./table-CpdBFqUb.js";
import "./download-CPqjANUi.js";
import "./upload-BmiwQOmh.js";
import "./file-down-BOOmYtoZ.js";
import "./calendar-Bs1r5nkO.js";
/**
...
function useEmailLogs(clientId) {
...
function printClientCard(client, lastVisitTs) {
  const printWindow = window.open("", "_blank");
  if (!printWindow) return;
  const lastVisit = "Never";
...
<body>
  ...
  <div class="footer">Polypick Engineers Pvt Ltd | Generated ${(/* @__PURE__ */ new Date()).toLocaleDateString("en-IN")}</div>
  <br/>
...
function ClientDetailPage() {
  ...
  const [deleteAllContactsOpen, setDeleteAllContactsOpen] = reactExports.useState(false);
  ...
  const [emailLogDialogOpen, setEmailLogDialogOpen] = reactExports.useState(false);
  const [emailLogForm, setEmailLogForm] = reactExports.useState({
    subject: "",
  ...
  const handleDeleteAllContacts = async () => {
    ...
    try {
      ...
      ue.success("All contacts removed");
      setDeleteAllContactsOpen(false);
    } catch {
      ue.error("Failed to remove contacts");
    } finally {
      setIsSavingContact(false);
    }
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 md:p-8 space-y-6 animate-fade-in", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "contacts", className: "w-full", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          TabsTrigger,
          {
            ...
            children: [
              ...
              "Email Log",
              emailLogs.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  variant: "secondary",
                  className: "ml-1 h-5 min-w-5 px-1 text-xs",
                  children: emailLogs.length
                }
              )
            ]
          }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "contacts", className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
            ...
            client.email && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-sm", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "break-all flex-1", children: client.email }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  variant: "ghost",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2 flex-wrap", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            contacts.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                size: "sm",
                variant: "destructive",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-4 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 space-y-2 flex-1", children: [
                ...
                contact.email && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs text-muted-foreground", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "break-all flex-1", children: contact.email }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      variant: "ghost",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "email-log", className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Email communications with this client." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Dialog,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    children: "+ Add Email Log"
                  }
                ) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { "data-ocid": "client.email_log.dialog", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display", children: "Add Email Log" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "form",
                    {
                      onSubmit: (e) => {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Summary / Notes" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Textarea,
                            {
                              rows: 3,
        ...
        emailLogs.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: "No email logs yet. Add your first email record."
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: emailLogs.map((log, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Card,
          {
            "data-ocid": `client.email_log.item.${idx + 1}`,
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-start justify-between gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Badge,
                  {
                    variant: "secondary",
                    className: log.direction === "Sent" ? "bg-green-100 text-green-700 border-green-200" : "bg-blue-100 text-blue-700 border-blue-200",
                    children: log.direction
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-sm truncate", children: log.subject })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: log.date }),
              log.summary && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground line-clamp-2", children: log.summary })
            ] }) }) })
          },
          log.id
        )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AlertDialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { "data-ocid": "contact.delete_all.dialog", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { children: "Delete All Contacts?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogDescription, { children: "Yeh action is client ke SAARE contacts delete kar dega. Yeh undo nahi ho sakta." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { "data-ocid": "contact.delete_all.cancel_button", children: "Cancel" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              AlertDialogAction,
              {
