import { c as createLucideIcon, r as reactExports, D as useComposedRefs, E as useDirection, j as jsxRuntimeExports, G as createContextScope, H as Primitive, J as composeEventHandlers, K as useCallbackRef, N as useLayoutEffect2, O as clamp, Q as cn, R as useClients, T as useCreateClient, V as useDeleteClient, W as useAllVisits, a as useNavigate, b as useInternetIdentity, U as Users, B as Button, q as LoaderCircle, n as Plus, L as Label, I as Input, s as Select, v as SelectTrigger, w as SelectValue, x as SelectContent, y as SelectItem, X as Search, S as Skeleton, h as Badge, z as ue } from "./index-DbjPUQDs.js";
...
const RAIPUR_CLIENTS = [
  ...
  },
  {
    ...
    email: "",
    address: "Raipur",
    notes: "Additional contact: Prem Sagar Vaishnav – 7611144406 (Alt: 8770404847)"
  },
  {
    name: "Chetan Sahu",
    company: "Hira Ferro",
  ...
  // ── Lloyds Steel & Energy (3 contacts grouped) ────────────────────────────
  {
    ...
    email: "",
    address: "Raipur",
    notes: "Additional contacts: Jaganath Raut – 7041303794 | Saran Mahgoan (HO) – 9437058214"
  },
  {
    name: "Nitin Shelare",
    company: "Uttam Galva",
  ...
  // ── Maharashtra ──────────────────────────────────────────────────────────
  {
    ...
    email: "",
    address: "Maharashtra",
    notes: "Additional contacts: Arjun Rajput – 6386316981 | Jeetendra Pandey – 9005099841"
  },
  // ── Chandrapur ───────────────────────────────────────────────────────────
  {
    name: "Pravin Channe",
  ...
  // ── Mukutwan ─────────────────────────────────────────────────────────────
  {
    ...
    email: "",
    address: "Mukutwan",
    notes: "Additional contacts: Sambhu Dayal Bhargav – 9145019166 | Akshay Srivastav – 8517948181"
  },
  {
...
function computeHealthScore(client, lastVisitTs) {
  let score = 0;
  const now = Date.now();
  if (lastVisitTs !== void 0) {
    const lastMs = Number(lastVisitTs / 1000000n);
    const diffDays = (now - lastMs) / (1e3 * 60 * 60 * 24);
...
function HealthScoreBadge({ score }) {
  if (score >= 80) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-emerald-50 text-emerald-700 border border-emerald-200", children: "✓ Healthy" });
  }
  if (score >= 50) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-amber-50 text-amber-700 border border-amber-200", children: "~ Moderate" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-red-50 text-red-700 border border-red-200", children: "! Attention" });
}
function ClientsPage() {
  ...
  const [isBulkAddingRaipur, setIsBulkAddingRaipur] = reactExports.useState(false);
  ...
  const handleBulkAddRaipur = async () => {
    ...
    try {
      ...
      ue.success("48 Raipur/CG clients added successfully!");
    } catch {
      ue.error("Failed to add some clients. Please try again.");
    } finally {
  ...
  const handleExcelImport = async (e) => {
    ...
    try {
      ...
      for (const cols of rows) {
        ...
        const phone2 = String(cols[2] ?? "").trim();
      ...
      console.error(err);
      ue.error("Import failed. Please check the file format.");
    } finally {
  ...
  const handleDeleteAll = async () => {
    ...
    try {
      ...
      ue.success(`${allClients.length} clients deleted`);
      setDeleteAllOpen(false);
    } catch {
      ue.error("Failed to delete all clients");
    } finally {
      setIsDeleting(false);
    }
  };
    ...
    try {
      ...
      const parsed = selected.map(
        (contact) => {
          ...
          const phone2 = (((_b = contact.tel) == null ? void 0 : _b[0]) ?? "").replace(/\s+/g, "").trim();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 md:p-8 space-y-6 animate-fade-in", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              isBulkAddingRaipur ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 16, className: "animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Database, { size: 16 }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border border-border overflow-hidden shadow-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { "data-ocid": "clients.table", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "bg-muted/30", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-semibold", children: "Mobile" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-semibold", children: "Industry" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "hidden lg:table-cell font-semibold", children: "Health" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: isLoading ? Array.from({ length: 5 }).map((_, i) => (
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "hidden lg:table-cell", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-16" }) }),
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          TableRow,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-muted-foreground text-sm", children: client.phone ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Smartphone,
                  {
                    size: 12,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: industry ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  variant: "outline",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "hidden lg:table-cell", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                HealthScoreBadge,
                {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AlertDialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { "data-ocid": "clients.delete_all.dialog", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { children: "Saare Clients Delete Karein?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogDescription, { children: "Yeh action SAARE clients aur unka data permanently delete kar dega. Yeh undo nahi ho sakta. Kya aap sure hain?" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { "data-ocid": "clients.delete_all.cancel_button", children: "Cancel" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              AlertDialogAction,
              {
                ...
                disabled: isDeleting,
                children: [
                  isDeleting ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "mr-2 h-4 w-4 animate-spin" }) : null,
