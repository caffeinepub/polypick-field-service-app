import { as as commonjsGlobal, at as getDefaultExportFromCjs, r as reactExports, au as clsx, av as React, aw as invariant, ax as useTotalClientsCount, W as usePipelineStats, ay as useInteractionsSummary, az as useClaimsSummaryPerStaff, aA as useVisitLogsCountPerStaff, ac as useAllClaims, T as useAllVisits, j as jsxRuntimeExports, aB as ChartColumn, B as Button, F as FileText, C as Card, l as CardContent, S as Skeleton, U as Users, _ as TrendingUp, ah as Receipt, an as CalendarCheck, i as CardHeader, k as CardTitle, L as Label$1, q as Select, s as SelectTrigger, v as SelectValue, w as SelectContent, x as SelectItem } from "./index-B35ZsBaz.js";
...
function ReportsPage() {
  ...
  const [summaryMonth, setSummaryMonth] = reactExports.useState(now2.getMonth());
  const [summaryYear, setSummaryYear] = reactExports.useState(now2.getFullYear());
  ...
  const approvedClaimsTotal = (allClaims ?? []).filter((c2) => c2.status === "approved").reduce(
    (acc, c2) => acc + Number(c2.travelAllowance) + Number(c2.dailyAllowance),
    0
  );
  const expenseSummary = (allClaims ?? []).reduce(
    (acc, c2) => {
      const cat = c2.expenseCategory || "Other";
      const amount = Number(c2.travelAllowance) + Number(c2.dailyAllowance);
  ...
  const expenseRows = Object.entries(expenseSummary).sort(
    (a2, b2) => b2[1].total - a2[1].total
  );
  const expenseTotal = expenseRows.reduce((s2, [, v2]) => s2 + v2.total, 0);
  const handleGenerateMonthlySummaryPDF = () => {
    const monthVisits = (allVisits ?? []).filter((v2) => {
      const d2 = new Date(Number(v2.plannedDate / 1000000n));
      return d2.getFullYear() === summaryYear && d2.getMonth() === summaryMonth;
    });
    const monthClaims = (allClaims ?? []).filter((c2) => {
      const d2 = new Date(Number(c2.date / 1000000n));
      return d2.getFullYear() === summaryYear && d2.getMonth() === summaryMonth;
    });
    const totalPlanned = monthVisits.filter(
      (v2) => v2.status === "planned"
    ).length;
    const totalCompleted = monthVisits.filter(
      (v2) => v2.status === "completed"
    ).length;
    const totalCancelled = monthVisits.filter(
      (v2) => v2.status === "cancelled"
    ).length;
    const uniqueClientIds = new Set(monthVisits.map((v2) => v2.clientId));
    ...
    const approvedClaimsAmt = monthClaims.filter((c2) => c2.status === "approved").reduce(
      (acc, c2) => acc + Number(c2.travelAllowance) + Number(c2.dailyAllowance),
      0
    );
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-5 pb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              pipelineLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-16 mt-1" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-3xl font-bold mt-1", children: pipelineData.reduce((a2, b2) => a2 + b2.value, 0) })
            ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: pipelineLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-56 w-full" }) : pipelineData.every((d2) => d2.value === 0) ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-56 flex items-center justify-center text-muted-foreground text-sm", children: "No pipeline data yet" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              BarChart,
              {
                data: pipelineData,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Select,
                      {
                        ...
                        onValueChange: (v2) => setSummaryMonth(Number(v2)),
                        children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Select,
                      {
                        ...
                        onValueChange: (v2) => setSummaryYear(Number(v2)),
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: yearOptions.map((y2) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: String(y2), children: y2 }, y2)) })
                        ]
                      }
                    )
                  ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "px-0 pb-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(TableBody, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "bg-muted/50 font-bold", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-center", children: expenseRows.reduce((s2, [, v2]) => s2 + v2.count, 0) }),
