import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, aX as Ticket, B as Button, C as Card, l as CardContent, h as Badge, I as Input, q as Select, s as SelectTrigger, v as SelectValue, w as SelectContent, x as SelectItem, aq as CircleCheck, ap as Clock, y as ue, L as Label } from "./index-B35ZsBaz.js";
...
import { C as CircleX } from "./circle-x-D-cTxHgz.js";
import { C as CircleAlert } from "./circle-alert-C4VgWvKS.js";
...
function ServiceTicketsPage() {
  ...
  const filtered = tickets.filter((t) => {
    ...
    if (q && !t.clientName.toLowerCase().includes(q) && !t.ticketNo.toLowerCase().includes(q) && !t.issueDescription.toLowerCase().includes(q))
      return false;
    return true;
  });
  const openAdd = () => {
    setForm({ ...empty, dateCreated: (/* @__PURE__ */ new Date()).toISOString().slice(0, 10) });
    setAddOpen(true);
  };
  const openEdit = (t) => {
    setEditTicket(t);
  ...
  const handleSave = () => {
    if (!form.clientName.trim() || !form.issueDescription.trim()) {
      ue.error("Client name and issue description are required");
      return;
    }
    if (editTicket) {
  ...
  const TicketForm = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: addOpen, onOpenChange: setAddOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-lg", "data-ocid": "tickets.add.dialog", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TicketForm, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleSave, "data-ocid": "tickets.add.submit_button", children: "Create Ticket" })
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Dialog,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-lg", "data-ocid": "tickets.edit.dialog", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleSave, "data-ocid": "tickets.edit.save_button", children: "Save Changes" })
              ] })
            ] })
          }
        ),
