import { c as createLucideIcon, a as useNavigate, ab as useIsAdmin, aA as useVisitLogsCountPerStaff, az as useClaimsSummaryPerStaff, aC as useAssignRole, r as reactExports, j as jsxRuntimeExports, aD as UserCog, B as Button, aB as ChartColumn, S as Skeleton, n as User, h as Badge, aE as Shield, L as Label, I as Input, q as Select, s as SelectTrigger, v as SelectValue, w as SelectContent, x as SelectItem, p as LoaderCircle, aF as Principal, y as ue } from "./index-B35ZsBaz.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 md:p-8 space-y-6 animate-fade-in", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { value: activeTab, onValueChange: setActiveTab, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "performance", "data-ocid": "staff.performance_tab", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { size: 14, className: "mr-1.5" }),
          "Performance"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "overview", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border border-border overflow-hidden shadow-xs mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { "data-ocid": "staff.table", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "performance", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border border-border overflow-hidden shadow-xs mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { "data-ocid": "staff.performance.table", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "bg-muted/30", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-semibold", children: "#" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-semibold", children: "Principal ID" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-semibold text-center", children: "Visits (All)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-semibold text-center", children: "Claims (All)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-semibold text-center", children: "Reports (This Month)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-semibold text-right", children: "Approved (₹)" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: isLoading ? Array.from({ length: 4 }).map((_, i) => (
          // biome-ignore lint/suspicious/noArrayIndexKey: skeleton loader
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { children: Array.from({ length: 6 }).map((__, j) => (
            // biome-ignore lint/suspicious/noArrayIndexKey: skeleton loader
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-full" }) }, `perf-cell-${j}`)
          )) }, `perf-skeleton-${i}`)
        )) : staffList.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          TableCell,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "No performance data yet" })
            ]
          }
        ) }) : staffList.map((staff, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          TableRow,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  variant: reportsCountMap[staff.principal] > 0 ? "default" : "secondary",
                  className: "text-xs",
                  children: reportsCountMap[staff.principal] ?? 0
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(TableCell, { className: "text-right font-medium text-emerald-700", children: [
                "₹",
