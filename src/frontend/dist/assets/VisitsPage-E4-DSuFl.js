import { c as createLucideIcon, r as reactExports, t as todayInputStr, a5 as useIsAdmin, ad as useAllVisits, ae as useMyVisits, A as useClients, af as useCreateVisit, ag as useUpdateVisit, ah as useDeleteVisit, b as useInternetIdentity, j as jsxRuntimeExports, ai as CalendarCheck, B as Button, C as Card, l as CardContent, S as Skeleton, m as formatDate, aj as ArrowRight, h as Badge, o as StatusBadge, ak as CircleCheck, i as CardHeader, k as CardTitle, L as Label, q as Select, s as SelectTrigger, v as SelectValue, w as SelectContent, x as SelectItem, I as Input, p as LoaderCircle, y as ue, z as dateInputToNs } from "./index-DmVPSM7c.js";
...
import { A as ArrowLeft } from "./arrow-left-ByLDEE5O.js";
...
function VisitsPage() {
  ...
  const handleAdd = async (e) => {
    ...
    try {
      ...
      const purposeWithGps = form.capturedGps ? `${formatGPS(form.capturedGps.lat, form.capturedGps.lng)} ${travelPurpose}` : travelPurpose;
  ...
  const handleExportMonthlyExcel = () => {
    ...
    utils.book_append_sheet(wb, ws, "Visit Plan");
    const monthStr = `${MONTH_NAMES[currentMonth]}${currentYear}`;
    writeFileSync(wb, `visit_plan_${monthStr}.xlsx`);
    ...
    if (ext === "xlsx" || ext === "xls") {
      ...
      reader.onload = (ev) => {
        ...
        try {
          ...
          if (rows.length < 2) {
            ue.error("Excel file is empty or has no data rows");
            return;
          }
          setBulkRows(parseBulkRows(rows, clientList));
        } catch {
          ue.error("Failed to parse Excel file");
        }
      };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 md:p-8 space-y-6 animate-fade-in pb-20 md:pb-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Dialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-lg", "data-ocid": "visits.add.dialog", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Select,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { "data-ocid": "visits.client.select", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select client" }) }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  ...
                  children: [
                    createVisit.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "mr-2 h-4 w-4 animate-spin" }) : null,
                    "Plan Visit"
                  ]
                }
              )
